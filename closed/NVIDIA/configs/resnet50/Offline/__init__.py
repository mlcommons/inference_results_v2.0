...
class Triton_CPU_4S_8380Hx1_Triton(OfflineCPUBaseConfig):
    ...
    max_queue_delay_usec = 230
    num_instances = 112
    ov_parameters = {'CPU_THREADS_NUM': '112', 'CPU_THROUGHPUT_STREAMS': '112', 'ENABLE_BATCH_PADDING': 'YES', 'SKIP_OV_DYNAMIC_BATCHSIZE': 'YES'}
