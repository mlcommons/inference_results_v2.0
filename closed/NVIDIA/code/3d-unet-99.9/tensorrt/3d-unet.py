...
class UnetBuilder(TensorRTEngineBuilder):
    ...
    def initialize(self) -> None:
        ...
        # Only use INT8 CDHW32 input for now, for the TRT engine
        assert self.input_dtype == "int8" and self.input_format == "cdhw32",\
            "3D-UNet has to be built with INT8 CDHW32 input"
