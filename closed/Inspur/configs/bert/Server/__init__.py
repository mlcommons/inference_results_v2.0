...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5468M6_A100_PCIe_80GBx12(ServerGPUBaseConfig):
    system = KnownSystem.NF5468M6_A100_PCIe_80GBx12
    active_sms = 60
...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NF5468M6_A100_PCIe_80GBx12_HighAccuracy(NF5468M6_A100_PCIe_80GBx12):
    precision = "fp16"
    server_target_qps = 16800
    gpu_batch_size = 32
    gpu_copy_streams = 4
    gpu_inference_streams = 1
    deque_timeout_usec = 12000


@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5468M6_A100_PCIe_80GBx12_Triton(NF5468M6_A100_PCIe_80GBx12):
    server_target_qps = 34500.0
    use_triton = True


@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NF5468M6_A100_PCIe_80GBx12_HighAccuracy_Triton(NF5468M6_A100_PCIe_80GBx12_HighAccuracy):
    server_target_qps = 16200
    use_triton = True
