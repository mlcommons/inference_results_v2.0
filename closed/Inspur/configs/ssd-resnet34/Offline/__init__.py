...
@ConfigRegistry.register(HarnessType.LWIS, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5468M6_A100_PCIe_80GBx12(OfflineGPUBaseConfig):
    system = KnownSystem.NF5468M6_A100_PCIe_80GBx12
    gpu_batch_size = 64
    gpu_copy_streams = 4
    gpu_inference_streams = 2
    offline_expected_qps = 11100.0
    run_infer_on_copy_streams = False
    use_graphs = False
