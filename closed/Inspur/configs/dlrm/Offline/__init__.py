...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5468M6_A100_PCIe_80GBx12(A100_PCIe_80GBx1):
    system = KnownSystem.NF5468M6_A100_PCIe_80GBx12
    offline_expected_qps = 3420000
    numa_config = "0,1,2,3,4,5:0-31,64-95&6,7,8,9,10,11:32-63,96-127"
...
class NF5468M6_A100_PCIe_80GBx12_Triton(NF5468M6_A100_PCIe_80GBx12):
    offline_expected_qps = 3015000
    batch_triton_requests = True
    buffer_manager_thread_count = 0
    gpu_batch_size = 367400
    gpu_copy_streams = 4
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NF5468M6_A100_PCIe_80GBx12_HighAccuracy_Triton(NF5468M6_A100_PCIe_80GBx12_Triton):
    offline_expected_qps = 3015000
    gpu_batch_size = 367400
    gpu_copy_streams = 4
    gpu_inference_streams = 1
