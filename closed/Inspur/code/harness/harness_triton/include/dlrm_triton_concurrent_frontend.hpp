...
{
  public:
    DLRM_Triton_SUT(const std::string& name, const std::string& model_repo_path,
        ...
        : Concurrent_Frontend_SUT(name, model_repo_path, model_name, model_version, use_dlrm_qsl,
  ...
  protected:
    ...
    size_t GetNumQuerySamplesToAcquire(size_t num_pairs, int num_successful_tries,
                                       int num_empty_tries);
