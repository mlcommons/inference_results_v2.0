...
plugin_map = {
    ...
    Benchmark.ResNet50: ["build/plugins/Serial3Conv2dPlugin/libserial3conv2dplugin.so"],
...
class BaseBenchmarkHarness:
    ...
    def get_system_name(self, add_trt=True):
        ...
        for kw, replacement in sys_marketing_name_map:
            if self.system_id.startswith(kw):
                system_name = system_name.replace(kw, replacement, 1)
                break
