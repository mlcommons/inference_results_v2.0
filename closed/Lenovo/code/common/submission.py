...
def generate_readme(readme_path, system_name, short_benchmark_name, scenario):
    ...
    if "Triton_CPU" in system_name:
        ...
        ```
        make run_cpu_harness RUN_ARGS="--benchmarks={benchmark} --scenarios={scenario} --test_mode=AccuracyOnly"
        make run_cpu_harness RUN_ARGS="--benchmarks={benchmark} --scenarios={scenario} --test_mode=PerformanceOnly"
        ```
...
def generate_analyzer_table(analyzer_table_path, system_name):
    system_name_to_power_cfg_map = {
        ...
        "A100-PCIe-80GBx8_TRT_Triton_MaxQ": "ipp1-1469",
        ...
        "DGX-A100_A100-SXM-80GBx8_TRT_Triton_MaxQ": "sjc1-luna-02",
        "DGX-Station-A100_A100-SXM-80GBx4_TRT_MaxQ": "computelab-ro-prod-01",
        "DGX-Station-A100_A100-SXM-80GBx4_TRT_Triton_MaxQ": "computelab-ro-prod-01",
