...
class A30x2(A30x1):
    ...
    gemm_plugin_fairshare_cache_size = 120
    gpu_batch_size = 1024
    offline_expected_qps = 3871.9999999999998
    workspace_size = 7516192768


@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A30x2_HighAccuracy(A30x2):
    precision = "fp16"
    offline_expected_qps = 2028.9999999999999
...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A100_80GB_PCIEX2_HighAccuracy(A100_80GB_PCIEX2):
    precision = "fp16"
    offline_expected_qps = A100_80GB_PCIEX2.offline_expected_qps / 2
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A100_80GB_PCIEX2_HighAccuracy_Triton(A100_80GB_PCIEX2_HighAccuracy):
    use_triton = True
