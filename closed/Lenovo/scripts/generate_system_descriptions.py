...
submission_systems = [
    ...
    System(SJC1_LUNA_02_MIG_1, Division.CLOSED, SystemType.DATACENTER, 1, 1, False, False),  # A100-SXM-80GB-MIG-1x1g.10gb for datacenter
    System(SJC1_LUNA_02_MIG_1, Division.CLOSED, SystemType.DATACENTER, 1, 1, True, False),  # A100-SXM-80GB-MIG-1x1g.10gb-Triton for datacenter
