...
custom_systems['A30x8_Custom_R5300G5'] = SystemConfiguration(host_cpu_conf=CPUConfiguration(layout={CPU(name="Intel(R) Xeon(R) Platinum 8380 CPU @ 2.30GHz", architecture=CPUArchitecture.x86_64, core_count=40, threads_per_core=1): 2}), host_mem_conf=MemoryConfiguration(host_memory_capacity=Memory(quantity=1.0564949199999998, byte_suffix=ByteSuffix.TB), comparison_tolerance=0.05), accelerator_conf=AcceleratorConfiguration(layout={KnownGPU.A30.value: 8}), numa_conf=None, system_id="A30x8_Custom_R5300G5")
