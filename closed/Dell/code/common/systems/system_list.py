...
add_systems("DSS8440_A100_PCIE_80GBx10", "DSS8440_A100-PCIE-80GBx10",
            MatchAllowList([KnownCPU.Intel_Xeon_Gold_6258R.value, KnownCPU.x86_64_Generic.value]),
            KnownGPU.A100_PCIe_80GB.value, [1, 8], Memory(30, ByteSuffix.GiB))

# A100_SXM4_40GB and SXM_80GB based systems:
add_systems("A100_SXM4_40GBx{}", "A100-SXM4-40GBx{}",
            MatchAllowList([KnownCPU.AMD_EPYC_7742.value, KnownCPU.x86_64_Generic.value]),
...
add_systems("A100_SXM_80GB_ROx{}", "RedOctober-A100-SXM-80GBx{}",
            MatchAllowList([KnownCPU.AMD_EPYC_7742.value, KnownCPU.x86_64_Generic.value]),
...
add_systems("A100_SXM4_40GB_MIG_{}x1g_5gb", "A100-SXM4-40GB-MIG_{}x1g.5gb", KnownCPU.AMD_EPYC_7742.value,
            KnownMIG.A100_SXM4_40GB_1GPC.value, [1, 56], Memory(1, ByteSuffix.TiB))
add_systems("A100_SXM_80GB_MIG_{}x1g_10gb", "A100-SXM-80GB-MIG_{}x1g.10gb", KnownCPU.AMD_EPYC_7742.value,
            KnownMIG.A100_SXM_80GB_1GPC.value, [1, 7, 56], Memory(1, ByteSuffix.TiB))
add_systems("A100_SXM_80GB_RO_MIG_{}x1g_10gb", "RedOctober-A100-SXM-80GB-MIG_{}x1g.10gb",
...
add_systems("DRIVE_A100_PCIE", "DRIVE_A100_PCIE",
...
class SystemClassifications:
    ...
    def start_from_device_enabled(cls, sys):
        return sys in [
            ...
            KnownSystem.XE8545_A100_SXM_80GBx1,
            KnownSystem.XE8545_A100_SXM_80GB_1xMIG,
            KnownSystem.R750xa_A100_PCIE_80GBx4,
            KnownSystem.DSS8440_A100_PCIE_80GBx10,
        ]
