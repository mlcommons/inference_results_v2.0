                            ...
                            const std::vector<std::string>& outputs)
{
    ...
    {
        instances_.emplace_back(new DLARequestPool(initial_element_count, server, server_sut,
...
DLARequestPool::DLARequestPool(const size_t initial_element_count, TRITONSERVER_Server* server,
                               ...
                               const std::vector<InputMetaData>& inputs,
                               const std::vector<std::string>& outputs)
...
void DLARequestPool::InternalInitInferenceRequest(DLARequestPool::Block* block)
{
    ...
    FAIL_IF_ERR(
        TRITONSERVER_InferenceRequestSetReleaseCallback(block->m_Data, DLARequestRelease, block),
