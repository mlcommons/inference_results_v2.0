...
DEFINE_bool(batch_triton_requests, false,
            "Batch-requests before they are sent to Triton; Unused in Multi-MIG harness");

DEFINE_uint32(
    num_batchers, 2,
    "Use triton_server_v2 with concurrent batching and issue. Unused in Multi-MIG harness.");
DEFINE_uint32(
    num_issuers, 2,
    "Use triton_server_v2 with concurrent batching and issue. Unused in Multi-MIG harness.");
// QSL flags
    ...
    triton_frontend::sharedMR_ptr s2c_shmem)
{
    ...
    sut = std::make_shared<triton_frontend::Server_SUT>(
        ...
        FLAGS_use_dlrm_qsl, FLAGS_start_from_device, FLAGS_pinned_input, FLAGS_mig_uuid,
...
int main(int argc, char** argv)
{
    ...
    switch (test_settings.scenario)
    {
        ...
        case mlperf::TestScenario::Server:
            expected_qps = test_settings.server_target_qps / double(FLAGS_num_migs);
            break;
