...
add_systems("NC24ads_A100_v4", "NC24ads_A100_v4",
            MatchAllowList([KnownCPU.AMD_EPYC_7742.value, KnownCPU.x86_64_Generic.value]),
            KnownGPU.A100_PCIe_80GB.value, [1], Memory(30, ByteSuffix.GiB))
add_systems("NC48ads_A100_v4", "NC48ads_A100_v4",
            MatchAllowList([KnownCPU.AMD_EPYC_7742.value, KnownCPU.x86_64_Generic.value]),
...
add_systems("ND96asr_v4", "ND96asr_v4",
            MatchAllowList([KnownCPU.AMD_EPYC_7742.value, KnownCPU.x86_64_Generic.value]),
...
class SystemClassifications:
    ...
    def start_from_device_enabled(cls, sys):
        return sys in [
            KnownSystem.ND96amsr_A100_v4,KnownSystem.ND96asr_v4
        ]
