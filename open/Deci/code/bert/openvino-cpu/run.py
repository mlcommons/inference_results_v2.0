...
def get_args():
    ...
    parser.add_argument("--batch_size", type=int, default=16,
                        help="batch_size")
    parser.add_argument("--infery_pro_return_cycle", type=int, default=128,
                        help="once in how many sample will infery pro return value")
    parser.add_argument("--num_inferencers", type=int, default=2,
                        help="once in how many sample will infery pro return value")
    parser.add_argument("--model_path", type=str, default=None,
                        help="path to model")

    parser.add_argument("--log_path", type=str, default="build/logs",
                        help="path to write_logs")
    parser.add_argument("--tokenizer", type=str,choices=['bert', 'deci'], default='bert',
                        help="tokenizer")
