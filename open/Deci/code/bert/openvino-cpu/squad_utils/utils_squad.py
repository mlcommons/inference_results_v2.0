...
def convert_examples_to_features(examples, tokenizer, max_seq_length,
                                 doc_stride, max_query_length, is_training, pad_token=0):
    ...
    for (example_index, example) in enumerate(all_examples):
        ...
        for pred in prelim_predictions:
            ...
            if pred.start_index > 0:  # this is a non-null prediction
                ...
                final_text = get_final_text(tokenizer, tok_text, orig_text, do_lower_case, verbose_logging)
...
def postprocess_qa_predictions(
    ...
    for example_index, example in enumerate(tqdm(examples)):
        ...
        if len(example_subset) != 0:
            example_index = example_subset[example_index]
        ...
        for feature_index in feature_indices:
            ...
            # context.
            offset_mapping = features[feature_index].token_to_orig_map[0]
        ...
        if not version_2_with_negative:
            ...
            if (-0.492*best_non_null_pred["start_logit"] + -0.544*best_non_null_pred["end_logit"] + 0.424*min_null_prediction['start_logit'] + 0.668*min_null_prediction['end_logit']) > 0:
