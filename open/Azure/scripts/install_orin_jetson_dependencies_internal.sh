...
# install CUDNN
wget --no-check-certificate http://cuda-repo/release-candidates/kitpicks/cudnn-v8-3-cuda-11-4/8.3.2.49/004/local_installers/cudnn-local-repo-ubuntu2004-8.3.2.49_1.0-1_arm64.deb -O cudnn8.3.2.deb \
  && sudo dpkg -i ./cudnn8.3.2.deb \
  && sudo apt-key add /var/cudnn-local-repo-ubuntu2004-8.3.2.49/7fa2af80.pub \
  && sudo apt update \
