...
namespace OV {
	...
	class BootstrapNAS : public WorkloadBase {
	public:
		BootstrapNAS(){
			this->input_blob_names_.push_back("result");
			this->output_blob_names_.push_back("1104");
    ...
    class BootstrapNAS_C : public WorkloadBase {
	public:
		BootstrapNAS_C(){
			this->input_blob_names_.push_back("result");
			this->output_blob_names_.push_back("1184");
			this->dataset_ = "imagenet";
		}
	...
	public:
		ResNet50(){
			...
			this->output_blob_names_.push_back("softmax_tensor");
			this->dataset_ = "imagenet";
		}
	...
	public:
		SSDResNet() {
			...
			this->output_blob_names_.push_back("bboxes");
			this->output_blob_names_.push_back("scores");
			this->output_blob_names_.push_back("labels");
			this->dataset_ = "coco";
		}
